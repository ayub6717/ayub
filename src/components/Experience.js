...
<div id="experience">
  <Container>
    ...
    <div className="md:pl-24">
      <h3>Lead Front-End Developer ( React JS)</h3>
      <h4 className="mt-3 text-[#2c2c2c]">Company Name: Techvillage (Software  Company)   </h4>
      ...
      <h4 className="mt-3 text-[#2c2c2c]">Company: Amader Service Global Limited (IT & Commercial Conservatory Company)</h4> 
      <p className="mt-1 text-[#1b1b1bee] text-[16px]">Address: House No: 18, Road #7, Ranavola, Uttara, Dhaka.</p>
      ...
      <h4 className="mt-3 text-[#2c2c2c]">Company: HRSOFTBD (Software Development company)</h4>
      <p className="mt-1 text-[#1b1b1bee] text-[16px]">Address: 12/6, Solimullah Road, Mohammadpur, Dhaka.</p>
      <p className="text-[#1b1b1bc7] text-[15px]">Status: 4th January 2020 to 6th January 2021.</p>
      <p className="mt-4 text-[17px]">
