        ...
        {/* first col */}
          <div className="md:px-6 intro mt-[100px] md:mt-[150px] lg:mt-[200px] mb-0 md:mb-[60px] lg:-mb-0 ml-0 md:ml-[58px] lg:ml-0" data-aos="fade-down">
            <div>
              ...
              <a className="btn" target="_blank" rel="noopener noreferrer" href="https://drive.google.com/file/d/1eKdPP2tcZ-yxeT0aPRvGZ-Qd8y8FVshU/view?usp=sharing">Get Resume</a>
